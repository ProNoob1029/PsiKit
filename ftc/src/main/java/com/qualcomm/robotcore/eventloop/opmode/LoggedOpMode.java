...
public abstract class LoggedOpMode extends OpMode {
    ...
    protected String rlogFolder = "/sdcard/FIRST/PsiKit/";
    ...
    private void ensurePsiKitStarted() {
        ...
        if (!rlogFilename.isBlank()) {
            ...
            psiKitSession.startWithConfigure(
                    this,
                    rlogPort,
                    rlogFolder,
                    null,
  ...
  private void runOpModeWithSetup() throws InterruptedException {
      ensurePsiKitStarted();
      beforeUser();
      try {
          runOpMode();
  ...
  public void waitForStart() {
    ...
    private void waitForStartDefault() {
        while (!isStarted()) {
  ...
  public final boolean opModeInInit() {
    ...
    private boolean opModeInInitDefault() {
